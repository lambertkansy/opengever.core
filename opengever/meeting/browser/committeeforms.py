...
class AddForm(BaseWizardStepForm, dexterity.AddForm):
    ...
    def updateWidgets(self):
        ...
        if not is_word_meeting_implementation_enabled():
            ...
            self.widgets['protocol_header_template'].moden = HIDDEN_MODE
            self.widgets['protocol_suffix_template'].moden = HIDDEN_MODE
        else:
            self.widgets['excerpt_template'].mode = HIDDEN_MODE
            self.widgets['protocol_template'].moden = HIDDEN_MODE
